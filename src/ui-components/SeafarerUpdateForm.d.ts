...
export declare type SeafarerUpdateFormInputValues = {
    name?: string;
    surname?: string;
    fiscal_code?: string;
...
export declare type SeafarerUpdateFormValidationValues = {
...
export declare type SeafarerUpdateFormOverridesProps = {
    SeafarerUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type SeafarerUpdateFormProps = React.PropsWithChildren<{
    overrides?: SeafarerUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    seafarer?: Seafarer;
    onSubmit?: (fields: SeafarerUpdateFormInputValues) => SeafarerUpdateFormInputValues;
    onSuccess?: (fields: SeafarerUpdateFormInputValues) => void;
    onError?: (fields: SeafarerUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: SeafarerUpdateFormInputValues) => SeafarerUpdateFormInputValues;
    onValidate?: SeafarerUpdateFormValidationValues;
} & React.CSSProperties>;
export default function SeafarerUpdateForm(props: SeafarerUpdateFormProps): React.ReactElement;
