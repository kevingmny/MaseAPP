...
export default function SeafarerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFiscal_code(initialValues.fiscal_code);
    setDate_of_birth(initialValues.date_of_birth);
    setCity_of_residence(initialValues.city_of_residence);
    ...
    setDate_of_registration(initialValues.date_of_registration);
    setPreccint(initialValues.preccint);
    setUsername(initialValues.username);
    setPayment_method(initialValues.payment_method);
    setMaritime_compartment(initialValues.maritime_compartment);
    setBirth_place(initialValues.birth_place);
    setPassport_number(initialValues.passport_number);
    setRegistration_number(initialValues.registration_number);
    setTelephone_number(initialValues.telephone_number);
    setId_role(initialValues.id_role);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Seafarer(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SeafarerCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
